        ...
        jQuizler: function(questions) {
            ...
            return this.each(function(){
                ...
                $.each(questions, function(index, question){
                    ...
                    if (index != 0) {
                        html += "<button class=\"btn-prev font prev btn btn-info\"><i class='icon-arrow-left icon-white'></i> Назад</button>";
                    }

                    if (index != questions.length-1) {
                        html += "<button class=\"next font btn btn-success\">Далее <i class='icon-arrow-right icon-white'></i></button>";
